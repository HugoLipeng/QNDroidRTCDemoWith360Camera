...
import com.qiniu.droid.rtc.demo.utils.EglCore;
import com.qiniu.droid.rtc.demo.utils.EglSurfaceBase;
import com.qiniu.droid.rtc.demo.utils.OffscreenSurface;
...
import com.qiniu.droid.rtc.demo.utils.PGSkinUtils;
...
import static us.pinguo.prettifyengine.assist.PGAction.ParamType.i;

public class RoomActivity extends Activity implements QNRoomEventListener, ControlFragment.OnCallEvents, QNLocalVideoCallback {
    ...
    private PGSkinUtils mPGSkinUtils;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLocalWindow.getLocalSurfaceView().setLocalVideoCallback(this);
    ...
    public int onRenderingFrame(final int i, final int i1, final int i2, VideoFrame.TextureBuffer.Type type, long l) {
        Log.d("hugo", "onRenderingFrame: "+ i);
        lock.lock();
        if (mGLHandler == null ) return i;
        ...
        mGLHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                mPGSkinUtils.setCameraInfo(new CameraInfo(i1, i2, 0, mIsFront ? 270 : 90, mIsFront));

                mPGSkinUtils.frameProcess(null, i, mIsFirstFrame, false, mIsFront);
                // frameProcess(byte[] data, int textureId, boolean isFirstFrame, boolean isInitEGL,boolean isFront)
                mIsFirstFrame = false;
                //mNewData = mPGSkinUtils.getSkinSoftenByte();
                mTextureId = mPGSkinUtils.getSkinSoftenTextureId();
                Log.d("hugo", "run:  "+ mTextureId+"  width=> "+i+"   height=> "+i1);
    ...
    public void onSurfaceCreated() {
        Log.e("hugo", "onSurfaceCreated " + Thread.currentThread().getId());
    ...
    public void onSurfaceChanged(int i, int i1) {
        Log.d(TAG, "onSurfaceChanged: width=> "+i+"   height=> "+i1);
    }
